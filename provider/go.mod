module github.com/jgautheron/pulumi-phase/provider
...
replace (
	...
	github.com/phasehq/terraform-provider/shim => ./shim
)

require (
	github.com/phasehq/terraform-provider/shim v0.0.0
...
require (
	...
	github.com/phasehq/terraform-provider v0.2.0 // indirect
